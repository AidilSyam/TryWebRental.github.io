...
class MP_datasewa extends Model
{
    ...
    protected $allowedFields = ['id_pengguna', 'id_mobil', 'id_pemilik', 'tgl_sewa', 'tgl_kbl'];


    public function getSewa($id_user)
    {
        //return $this->where('kode_sewa', $kode_sewa)->first();
        return $this->select('data_sewa.kode_sewa, data_sewa.id_pengguna, data_sewa.id_mobil, data_sewa.tgl_sewa, data_sewa.tgl_kbl, data_klien.nama, data_mobil.mobil')
