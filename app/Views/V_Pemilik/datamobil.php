                            ...
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a type="button" class="btn" href="<?= base_url('/pemilik/V_Pemilik/datamobil/hapus/' . $mobils['id_mobil']) ?>" style="border-radius: 10px; background:#F1222E;">Hapus</a>
                                    </center>
                                </td>
                            </tr>
                            ...
                            <tr class="model" id="form_ubah_data_mobil-<?= $mobils['id_mobil'] ?>">
                                <td colspan="10">
                                    <div class="Eform">
                                        ...
                                        <form action="<?= base_url('/pemilik/V_Pemilik/datamobil/ubah/' . $mobils['id_mobil']) ?>" method="post" style="margin: 2em;" enctype="multipart/form-data">
                                            <div class="mb-3 row">
...
<div id="formulir">
    <div class="Eform">
        ...
        <form style="margin: 2em;" action="datamobil" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="mb-3 row">
                <label for="no_polisi" class="form-label col ">No.Polisi</label>
