            ...
            <div class="card">
                ...
                <?php foreach ($data_pemilik_kendaraan as $pemilik) : ?>
                    <div class="card-body">
                        ...
                        <a href="#editProfileModal-<?= $pemilik['id_pemilik'] ?>" data-bs-toggle="modal" class="btn btn-primary">Edit Profil</a>
                    </div>
                    <!-- Modal Edit -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= base_url('/pemilik/V_Pemilik/akun/ubah/' . $pemilik['id_pemilik']) ?>" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php foreach ($user as $users) : ?>
                        <form action="<?= base_url('/pemilik/V_Pemilik/akun/pengaturan/ubah/' . $users['id_user']) ?>" method="post">
                            <div class=" mb-3">
