...
<body class="d-flex justify-content-center align-items-center">
    <div class="container w-100 justify-content-center" style="height:100%">
        <div class="form-daftar">
            ...
            <form style="margin: 2em;" action="<?= site_url('registrasi/pemilik') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <label for="foto_pemilik" class="form-label col">Upload Foto Pemilik</label>
